...
```bash
wget --no-check-certificate https://raw.githubusercontent.com/faint32/shadowsocks-rust/main/ss-rust.sh && chmod +x ss-rust.sh && ./ss-rust.sh
```

**Docker版本** ( 无需预先安装Docker, 脚本自带安装 )
```bash
wget --no-check-certificate https://raw.githubusercontent.com/faint32/shadowsocks-rust/main/ss-rust-docker.sh && chmod +x ss-rust-docker.sh && ./ss-rust-docker.sh
```
